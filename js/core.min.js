    ...
    t.prototype = {
        ...
        open: function(t) {
            ...
            if (!m.isOpen) {
                ...
                h("BeforeOpen"), m.st.showCloseBtn && (m.st.closeBtnInside ? (d(v, function(t, e, i, o) {
                    ...
                    height: f.height(),
                    position: "absolute"
                }), m.st.enableEscapeKey && f.on("keyup" + w, function(t) {
                ...
                return m.isIE7 && (l += " mfp-ie7"), l && m._addClassToMFP(l), m.updateItemHTML(), h("BuildControls"), c("html").css(a), m.bgOverlay.add(m.wrap).prependTo(m.st.prependTo || c(document.body)), m._lastFocusedEl = document.activeElement, setTimeout(function() {
                    m.content ? (m._addClassToMFP(x), m._setFocus()) : m.bgOverlay.addClass(x), f.on("focusin" + w, m._onFocusIn)
                }, 16), m.isOpen = !0, m.updateSize(r), h(b), t
            }
            m.updateItemHTML()
        },
        close: function() {
        ...
        _close: function() {
            ...
            m.bgOverlay.detach(), m.wrap.detach(), m.container.empty(), m.st.mainClass && (t += m.st.mainClass + " "), m._removeClassFromMFP(t), m.fixedContentPos && (t = {
                marginRight: ""
            }, m.isIE7 ? c("body, html").css("overflow", "") : t.overflow = "", c("html").css(t)), f.off("keyup.mfp focusin" + w), m.ev.off(w), m.wrap.attr("class", "mfp-wrap").removeAttr("style"), m.bgOverlay.attr("class", "mfp-bg"), m.container.attr("class", "mfp-container"), !m.st.showCloseBtn || m.st.closeBtnInside && !0 !== m.currTemplate[m.currItem.type] || m.currTemplate.closeBtn && m.currTemplate.closeBtn.detach(), m.st.autoFocusLast && m._lastFocusedEl && c(m._lastFocusedEl).focus(), m.currItem = null, m.content = null, m.currTemplate = null, m.prevHeight = 0, h("AfterClose")
        },
        ...
        proto: {
            ...
            getInline: function(t, e) {
                if ($(), t.src) {
                    var i, o = m.st.inline,
                        n = c(t.src);
                    return n.length ? ((i = n[0].parentNode) && i.tagName && (T || (C = o.hiddenClass, T = u(C), C = "mfp-" + C), S = n.after(T).detach().removeClass(C)), m.updateStatus("ready")) : (m.updateStatus("error", o.tNotFound), n = c("<div>")), t.inlineElement = n
                }
    ...
    c.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var s = m.st.gallery,
                    t = ".mfp-gallery";
                return m.direction = !0, !(!s || !s.enabled) && (g += " mfp-gallery", d(b + t, function() {
            ...
            next: function() {
                m.direction = !0, m.index = M(m.index + 1), m.updateItemHTML()
            },
            prev: function() {
                m.direction = !1, m.index = M(m.index - 1), m.updateItemHTML()
            },
            goTo: function(t) {
            ...
            _preloadItem: function(t) {
                var e;
                t = M(t), m.items[t].preloaded || ((e = m.items[t]).parsed || (e = m.parseEl(t)), h("LazyLoad", e), "image" === e.type && (e.img = c('<img class="mfp-img" />').on("load.mfploader", function() {
                    e.hasSize = !0
...
function(i) {
    ...
    (function(t) {
        ...
        function w() {
            var e, i;
            v.length && (h = void 0 !== n.window.pageYOffset ? n.window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop, e = p || !b || b.width !== m || b.height !== f, i = g || e || !b || b.y !== h, g = p = !1, (e || i) && (v.forEach(function(t) {
