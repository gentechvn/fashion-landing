/*-----------------------------------------------------------------------------------
    ...
    Theme Name: Fabric - Fashion & Textile Manufacturing Template
    Description: Fashion & Textile Manufacturing Template
...
! function(t) {
    ...
    t("#preloader").fadeOut("normall", function() {
        ...
        t(".service-carousel").owlCarousel({
        ...
        }), t(".service-carousel2").owlCarousel({
            loop: !0,
            responsiveClass: !0,
            autoplay: !0,
            autoplayTimeout: 3e3,
            ...
            autoplay: !0,
            smartSpeed: 500
        }), t(".slider-fade-two").on("changed.owl.carousel", function(e) {
            e = e.item.index - 2;
            t("span").removeClass("animated fadeInUp"), t("h1").removeClass("animated fadeInUp"), t("a").removeClass("animated fadeInUp"), t(".owl-item").not(".cloned").eq(e).find("span").addClass("animated fadeInUp"), t(".owl-item").not(".cloned").eq(e).find("h1").addClass("animated fadeInUp"), t(".owl-item").not(".cloned").eq(e).find("a").addClass("animated fadeInUp")
        }), t(".countup").counterUp({
            delay: 25,
            time: 2e3
